    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (img10.src !== (img10_src_value = "logos/youtube.jpg")) attr_dev(img10, "src", img10_src_value);
    			attr_dev(img10, "alt", "Youtube");
    			attr_dev(img10, "align", "middle");
    			attr_dev(img10, "hspace", "20");
    			attr_dev(img10, "vspace", "10");
    			attr_dev(img10, "class", "svelte-16wde2k");
    			add_location(img10, file, 19, 36, 1446);
    			attr_dev(a10, "href", "https://www.youtube.com");
    			add_location(a10, file, 19, 2, 1412);
    			add_location(p2, file, 9, 1, 311);
    			attr_dev(p3, "id", "demo1");
    			add_location(p3, file, 21, 1, 1538);
    			add_location(script, file, 22, 1, 1558);
